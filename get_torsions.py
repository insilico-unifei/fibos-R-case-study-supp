...
# lenna@purdue.edu
# Modified by Pat Fleming, 2025

# """
# To obtain the side chain chi angles in space separated file,
# python3 get_torsions.py PDBcode.pdb -o PDB_torsions.dat -c 1 2 3 4 5
# 
# will give,
# id resn resi chi1 chi2 altchi2 chi3 chi4 chi5
# 7rsa LYS 27 162  161  -168 82 
# """
...
#           print("Outfile exists, it will be overwritten")
        ...
        self.fieldnames = ["id", "resn", "resi"] + self.chi_names
        ...
        with open(outfile, "w") as oh:
            w = csv.DictWriter(oh, fieldnames=self.fieldnames, delimiter=' ', lineterminator='\n')
            w.writeheader()
